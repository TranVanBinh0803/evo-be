package com.binhtv.articleservice.exception;

import com.binhtv.articleservice.dto.ApiResponse;
import com.binhtv.articleservice.dto.ValidationErrorDto;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ApiResponse<List<ValidationErrorDto>>> handleMethodArgumentNotValidException(
        ...
        List<ValidationErrorDto> errors = exception.getBindingResult().getFieldErrors().stream()
                ...
                .toList();
        ApiResponse<List<ValidationErrorDto>> response = new ApiResponse<>(
                "Validation failed!",
    ...
    public ResponseEntity<ApiResponse<ValidationErrorDto>> handleMethodArgumentTypeMismatchException(
        ...
        ValidationErrorDto error = ValidationErrorDto.builder()
                ...
                .build();
        ApiResponse<ValidationErrorDto> response = new ApiResponse<>(
    ...
    public ResponseEntity<ApiResponse<Void>> handleException(Exception exception) {
        log.error("Unexpected article-service error", exception);
    ...
    private ResponseEntity<ApiResponse<Void>> buildResponse(String message, HttpStatus status) {
        ApiResponse<Void> response = new ApiResponse<>(message, status.value(), null);
