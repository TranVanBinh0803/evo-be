...
import com.binhtv.authservice.security.service.UserDetailsServiceImpl;
import com.binhtv.authservice.security.utils.SecurityConstants;
...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
	...
	protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain chain)
		...
		final boolean canBeStartTokenValidation = Objects.nonNull(email) && Objects.isNull(securityContext.getAuthentication());
		...
		final String authenticatedEmail = user.getUsername();
		final boolean validToken = jwtTokenManager.validateToken(authToken, authenticatedEmail);
